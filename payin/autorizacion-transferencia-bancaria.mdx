---
title: "API de Autorización con Transferencia Bancaria"
sidebarTitle: "Transferencia Bancaria"
description: "Inicia pagos con transferencia bancaria desde el API de autorización de PayIn."
---

Usa este flujo para iniciar pagos ecommerce con transferencia bancaria desde el API de autorización de PayIn.
...
<CardGroup cols={2}>
  ...
  <Card title="Método de pago" icon="building-columns">
    Permite iniciar cobros ecommerce con transferencia bancaria.
  </Card>

  <Card title="Redirección" icon="arrow-up-right-from-square">
    El usuario continúa el pago fuera de tu checkout.
  </Card>
...
<Warning>
  No tomes como final la respuesta inicial del `POST /charges`. Confirma el resultado con [Notificaciones](/payin/notificaciones) o con [Consulta](/payin/consulta-transferencia-bancaria).
</Warning>
...
| Campo | Descripción | Ejemplo | Tipo | Obligatorio |
| :-- | :-- | :-- | :-- | :-- |
| `method_name` | Nombre del método de pago | `BANK_TRANSFER` | String | SI |
| `method_details` | Objeto con la información específica de la transferencia bancaria | Object | Object | SI |
...
| Campo | Descripción | Ejemplo | Tipo | Obligatorio |
| :-- | :-- | :-- | :-- | :-- |
| `method_name` | Nombre del método de pago usado en la transacción | `BANK_TRANSFER` | String | SI |
...
<CardGroup cols={2}>
  ...
  <Card title="Redirect incompleto" icon="ban">
    Si `redirect_url` no está correctamente implementado, el usuario puede completar el flujo bancario sin que tu comercio procese bien el retorno.
  </Card>
</CardGroup>
...
<Card title="Api de Consulta con Transferencia Bancaria" icon="arrow-right" href="/payin/consulta-transferencia-bancaria">
  Verifica cómo consultar el estado de una operación por transferencia bancaria.
</Card>
