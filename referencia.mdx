...
<CardGroup cols={2}>
  <Card title="Estados de Transacción" icon="arrow-progress" href="/estados-de-transaccion">
    Revisa el ciclo de vida del pago y los estados que debes mapear en tu backend.
  </Card>

  <Card title="Datos de Prueba" icon="credit-card-front" href="/flujos-de-pago">
    Usa tarjetas, credenciales y escenarios sandbox para validar tus flujos.
  </Card>

  <Card title="Códigos de Retorno" icon="receipt" href="/codigos-de-respuesta">
...
<Note>
  Si necesitas el detalle completo de cada estado, usa la página dedicada de [Estados de Transacción](/estados-de-transaccion).
</Note>
...
<Steps>
  <Step title="Prueba en sandbox">
    Usa [Datos de Prueba](/flujos-de-pago) para validar aprobaciones, rechazos y flujos por método de pago.
  </Step>

  <Step title="Mapea respuestas">
    Usa [Códigos de Retorno](/codigos-de-respuesta) para definir qué considera tu sistema como aprobado, rechazado o reintento.
  </Step>
