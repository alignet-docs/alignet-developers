...
- asociación y retorno de información adicional para desglose de importes y conciliación;
...
<Steps>
  ...
  <Step title="Solicitar la autorización">
    El SCC envía `operationNumber`, `amount` y `currency`. Puede incluir `additionalFields` para asociar el desglose de importes y el identificador de turno o vía.
  </Step>
...
- `additionalFields` mantiene información complementaria asociada a la operación y no reemplaza los campos requeridos.
