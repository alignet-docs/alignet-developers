...
<Info>
  La integración no asume autorización offline. La separación entre la LAN del carril y la comunicación WAN del terminal representa límites de conectividad distintos.
</Info>
...
<Steps>
  ...
  <Step title="Solicitar el pago">
    El SCC envía la referencia, monto, moneda, ubicación y datos del evento mediante la interfaz LAN acordada.
  </Step>
...
- Registrar trazabilidad suficiente sin almacenar credenciales ni datos sensibles de tarjeta.
...
<CardGroup cols={2}>
  ...
  <Card title="Contrato funcional" icon="file-contract" href="/procesamiento-fisico/alignet-transit/contrato-funcional">
    Información de solicitud, respuesta y estados funcionales.
  </Card>
...
La arquitectura, las responsabilidades y las reglas de integridad son permanentes. IP, puerto, credenciales, certificados, timeouts y asociaciones de terminal dependen del ambiente. Los schemas, códigos y parámetros particulares se registran en la especificación versionada de la interfaz y en la ficha de configuración correspondiente.
