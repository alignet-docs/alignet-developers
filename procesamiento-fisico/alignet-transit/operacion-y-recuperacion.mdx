...
| Restablecimiento de la conexión | Resolver el último estado antes de decidir otro envío. |
...
No registres PAN completo, datos EMV sensibles ni material criptográfico.
