...
```http
GET http://<IP_DEL_PINPAD>:<PUERTO>/payments/44992528
```
...
| `CANCELLED` | Sí | La autorización terminó cancelada; no equivale a un extorno. | No confirmes el cobro. Revisa [Cancelación de una autorización en curso](/procesamiento-fisico/alignet-transit/cancelacion). |
