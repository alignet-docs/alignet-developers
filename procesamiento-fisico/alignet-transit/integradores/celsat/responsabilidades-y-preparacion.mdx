...
| Operación | Calcular el monto, generar y persistir `operationNumber` y aplicar la decisión del carril. | Validar la solicitud; ejecutar el cobro, cancelación o extorno; y devolver el resultado. | Probar aprobación, rechazo, cancelación, extorno y recuperación. |
